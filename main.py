...
def main(page: ft.Page):
    ...
    def orjinal_excele_kaydet(e):
        ...
        if not os.path.exists(sablon_yolu):
            bilgi_notu.value = "Hata: Cihazın 'Download' klasöründe 'INSPECTION REPORT.xlsx' bulunamadı!"
